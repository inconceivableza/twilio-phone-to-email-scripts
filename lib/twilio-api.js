...
// Path to the locally-installed twilio CLI binary (from the twilio-cli package)
const TWILIO_BIN = path.join(__dirname, '..', 'node_modules', '.bin', 'twilio');
...
function checkTwilioCli() {
  try {
    const result = spawnSync(TWILIO_BIN, ['--version'], {
      encoding: 'utf8',
